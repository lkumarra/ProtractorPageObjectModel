...
export class LoginPage {
    ...
    public async setUserName(userName: string) {
        await testUtil.enterTextIntoTextBox(loginPageElements.userIdLocator(), userName);
    }
    ...
    public async setPassword(password: string) {
        await testUtil.enterTextIntoTextBox(loginPageElements.passwordLocator(), password);
    }
    ...
    public async login(userName: string, password: string): Promise<HomePage> {
        ...
        LogUtils.debugMessage("Username " + userName + " is entered", LoginPage.name);
        await this.setPassword(password);
        LogUtils.debugMessage("Password " + password + " is entered", LoginPage.name);
