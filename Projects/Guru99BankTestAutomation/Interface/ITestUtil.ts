...
export interface ITestUtil {
  ...
  /**
     ...
     */
  enterTextIntoTextBox(webElement: ElementFinder, keyValues: string): Promise<void>;
  ...
  /**
     ...
     * @param keyValues 
     */
  enterTextIntoTextBoxWithoutClear(WebElement: ElementFinder, keyValues: string): Promise<void>;
   ...
   */
  getAttributeOfElement(webElement: ElementFinder, attributeName: string): Promise<string>;
